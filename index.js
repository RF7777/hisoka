...
text: `Welcome!`, contextInfo: { mentionedJid: [m.sender],
externalAdReply: {
...
hisoka.sendMessage(anu.id, {
text: `Bye Beban`, contextInfo: { mentionedJid: [m.sender],
externalAdReply: {
...
hisoka.sendMessage(anu.id, {
text: `@${num.split("@")[0]} Is Now admin !`, contextInfo: { mentionedJid: [m.sender],
externalAdReply: {
...
hisoka.sendMessage(anu.id, {
text: `@${num.split("@")[0]} Is Now Member`, contextInfo: { mentionedJid: [m.sender],
externalAdReply: {
